...
void
shake128_init (shake128_state_t state)
{
  _shake128_init (state);
}

void
shake128_absorb (shake128_state_t state, const uint8_t *in, size_t len)
{
  _shake128_absorb (state, in, len);
}

void
shake128_squeeze (shake128_state_t state, uint8_t *out, size_t len)
{
  _shake128_squeeze (state, out, len);
}

void
shake128_clear (shake128_state_t state)
{
  _shake128_clear (state);
}
...
static void
_shake128_clear (shake128_state_t state)
{
  explicit_bzero (state, sizeof (shake128_state_struct));
}
