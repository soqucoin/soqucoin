...
// Copyright (c) 2013-2021 The Soqucoin Core developers
...
// le32dec/le32enc: Use system-provided versions if available.
// FreeBSD and macOS 26+ have them in <sys/endian.h>.
