...
const char * const BITCOIN_CONF_FILENAME = "soqucoin.conf";
const char * const BITCOIN_PID_FILENAME = "soqucoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Soqucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Soqucoin";
#else
    // Unix
    return pathRet / ".soqucoin";
#endif
#endif
}
