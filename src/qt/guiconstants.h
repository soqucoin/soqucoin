...
#define QAPP_ORG_NAME "Soqucoin"
#define QAPP_ORG_DOMAIN "soqucoin.org"
#define QAPP_APP_NAME_DEFAULT "Soqucoin-Qt"
#define QAPP_APP_NAME_TESTNET "Soqucoin-Qt-testnet"
