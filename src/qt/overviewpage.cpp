...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Soqucoin Core repository on GitHub"),
        tr("Services that claim to double your soqucoins are always ponzi schemes")
    };
