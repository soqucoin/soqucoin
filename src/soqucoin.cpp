...
// Soqucoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateSoqucoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetSoqucoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
