...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help")) {
        ...
        std::string strUsage = strprintf(_("%s soqucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  soqucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soqucoin transaction") + "\n" +
                               "  soqucoin-tx [options] -create [commands]   " + _("Create hex-encoded soqucoin transaction") + "\n" +
                               "\n";
