Soqucoin Core version 1.14.5 is now available from:

  <https://github.com/soqucoin/soqucoin/releases/tag/v1.14.5/>

This is a new minor version release, including important security updates and
changes to network policies. All Soqucoin Core users, miners, services, relay
operators and wallet users are strongly recommended to upgrade.

Please report bugs using the issue tracker at github:

  <https://github.com/soqucoin/soqucoin/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/soqucoindev/
  * @Soqucoin on Twitter for high priority announcements
  * @soqucoin\_devs on Twitter for updates on development work

Compatibility
==============

Soqucoin Core is extensively tested on Ubuntu Server LTS, Intel-based macOS
and Windows 10.

Soqucoin Core should also work on most other Unix-like systems but is not
...
most Soqucoin Core users.

### Remote Code Execution in Soqucoin QT (CVE-2021-3401)
...
**Soqucoin QT users are urged to please update their installations to this
...
leakage of sensitive information when Soqucoin Core crashes on Unix platforms.
The vulnerability is patched for systems that run a Linux kernel equal to or
higher than 3.4.

**Soqucoin Core wallet users on Linux platforms are urged to please update to
this version.**
...
the Soqucoin network, following the reduction of relay and mining defaults in
...
* The user interface for selecting fees when transacting DOGE has been updated
  ...
  Soqucoin blocks are not full, typically all transactions are mined in the next
  block, and therefore the target estimation does not makes sense for Soqucoin.
...
The Berkley DB version used by Soqucoin Core has been updated to 5.3 (from 5.1)
...
performance of cryptographic routines within Soqucoin Core.
