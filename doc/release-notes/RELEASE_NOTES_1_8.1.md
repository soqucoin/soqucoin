...
Soqucoin Core 1.8.1 is primarily a bugfix release, bringing Soqucoin Core in
line with Bitcoin 0.9.3. Soqucoin Core 1.8.1 also adds in support for printing
...
## Soqucoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by Soqucoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Soqucoin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/soqucoin/soqucoin/issues/134).
