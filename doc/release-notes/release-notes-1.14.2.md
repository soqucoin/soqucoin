Soqucoin Core version 1.14.2 is now available from:

  <https://github.com/soqucoin/soqucoin/releases/tag/v1.14.2/>
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/soqucoin/
...
Soqucoin Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Soqucoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Soqucoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Soqucoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Soqucoin Core. This was added in conjunction with
