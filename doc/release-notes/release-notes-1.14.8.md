Soqucoin Core version 1.14.8 is now available from:

  <https://github.com/soqucoin/soqucoin/releases/tag/v1.14.8/>

This is a new minor version release. Soqucoin users on any platform are
...
Several important updates have been added to Soqucoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Soqucoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Soqucoin Core
...
In previous versions of Soqucoin Core, orphan transactions were processed in a
...
Soqucoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Soqucoin Core.
...
* Soqucoin Core now supports compilation with C++14 and C++17, if you select
